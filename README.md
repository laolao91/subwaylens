...
63 Dr-Rego Park ★
▲ Forest Hills-71 Av
▶[M] Forest Hills-71 Av  2 min - 1:02
 [R] Forest Hills-71 Av  6 min - 1:06
─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─
▼ Middle Village
▶[M] Middle Village      2 min - 1:02
 [R] Bay Ridge-95 St     6 min - 1:06
━━━━━━━━━━━━━───────── 1/6
```

**Phone settings page:** Dark-themed UI for searching stations, managing favorites, and configuring preferences.
